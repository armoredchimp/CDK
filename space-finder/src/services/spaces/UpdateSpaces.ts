...
export async function updateSpace(event: APIGatewayProxyEvent, ddbClient: DynamoDBClient, context: Context): Promise<APIGatewayProxyResult> {
  ...
  if (event.queryStringParameters && ('id' in event.queryStringParameters) && event.body) {
    ...
    const reqBodyVal = event.body[reqBodyKey]
